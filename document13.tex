...
\end{align}
Where $C_1$ and $C_2$ are the column vectors of matrix $C$.
Now, row redution operation is applied to the matrix $A^T$:
\begin{multline}
\myvec{1 & 2 & 1\\-1 & 2 & 0} \xleftrightarrow[]{R_2\leftarrow R_1+R_2} \myvec{1 & 2 & 1\\0 & 4 & 1}\\
\xleftrightarrow[]{R_2\leftarrow R_2/2}\myvec{1 & 2 & 1\\0 & 2 & \frac{1}{2}}\xleftrightarrow[]{R_1\leftarrow R_1-R_2}\\
\myvec{1 & 0 & \frac{1}{2}\\0 & 2 & \frac{1}{2}}\xleftrightarrow[]{R_2\leftarrow R_2/2}\myvec{1 & 0 & \frac{1}{2}\\0 & 1 & \frac{1}{4}}
\end{multline}
Now,
\begin{align}
\myvec{1 & 0 & \frac{1}{2}\\0 & 1 & \frac{1}{4}}\myvec{| & |\\C_1 & C_2\\| & |} = \myvec{3 & -4\\1 & 4}\\
\implies \myvec{1 & 0 & \frac{1}{2}\\0 & 1 & \frac{1}{4}}\myvec{a_1\\b_1\\c_1} = \myvec{3\\-1}\\
\myvec{1 & 0 & \frac{1}{2}\\0 & 1 & \frac{1}{4}}\myvec{a_2\\b_2\\c_2} = \myvec{-4\\4}
\end{align}
Here $a_1,b_1,a_2,b_2$ are pivot variables but $c_1$ and $c_2$ are free variables. So the pivot variables can be expressed in terms of the free variables.
So,
\begin{align}
a_1 = 3 - \frac{c_1}{2}\\
b_1 = -1 - \frac{c_1}{4}\\
...
Now,
\begin{align}
C=\myvec{(3 - \frac{c_1}{2}) & (-1 - \frac{c_1}{4}) & c_1\\ (-4 - \frac{c_2}{2}) & (4 - \frac{c_2}{4}) & c_2}
\end{align}
%
%\renewcommand{\theequation}{\theenumi}
